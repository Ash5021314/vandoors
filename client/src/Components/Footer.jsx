    ...
    <>
      <footer className="footer backGround">
        <Container>
          <Row>
            ...
            <Col xs={6} md={2}>
              ...
              <ListGroup variant="flush">
                ...
                <ListGroup.Item className="padding0"><span><FontAwesomeIcon icon={faAngleRight} /></span> <span> Бренди</span> </ListGroup.Item>
                <ListGroup.Item className="padding0"><span><FontAwesomeIcon icon={faAngleRight} /></span> <span> Наши преимущества</span></ListGroup.Item>
                <ListGroup.Item className="padding0"><span><FontAwesomeIcon icon={faAngleRight} /></span> <span> Каталог</span></ListGroup.Item>
              </ListGroup>
            </Col>
            <Col xs={6} md={3}>
            ...
            <Col xs={6} md={4}>
              ...
              <ListGroup>
                <ListGroup.Item className="fz14"><span>С понедельника > До пятницы:</span><span>09։00 - 18։00</span></ListGroup.Item>
          ...
          <div className="copy"><span dangerouslySetInnerHTML={{ "__html": "&copy;" }} /> <span> Все права защищены</span> </div>
